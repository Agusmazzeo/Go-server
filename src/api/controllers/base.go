...
type IController interface {
	...
	GetAllAccounts(ctx context.Context, filter string) ([]*schemas.AccountReponse, error)
	GetAccountState(ctx context.Context, id string, date time.Time) (*schemas.AccountState, error)
	GetAccountStateDateRange(ctx context.Context, id string, startDate, endDate time.Time) (*schemas.AccountState, error)
