...
func (c *Controller) GetAllReportSchedules(ctx context.Context) ([]*schemas.ReportScheduleResponse, error) {
...
func (c *Controller) GetReportScheduleByID(ctx context.Context, ID uint) (*schemas.ReportScheduleResponse, error) {
...
func (c *Controller) CreateReportSchedule(ctx context.Context, req *schemas.CreateReportScheduleRequest) (*schemas.ReportScheduleResponse, error) {
	...
	if err := c.DB.WithContext(ctx).Create(&reportSchedule).Error; err != nil {
		return nil, err
	}
...
func (c *Controller) UpdateReportSchedule(ctx context.Context, req *schemas.UpdateReportScheduleRequest) (*schemas.ReportScheduleResponse, error) {
	var reportSchedule models.ReportSchedule
	if err := c.DB.WithContext(ctx).First(&reportSchedule, "id = ?", req.ID).Error; err != nil {
		return nil, err
	}
	...
	if err := c.DB.WithContext(ctx).Save(&reportSchedule).Error; err != nil {
		return nil, err
	}
...
func (c *Controller) DeleteReportSchedule(ctx context.Context, id uint) error {
	if err := c.DB.WithContext(ctx).Delete(&models.ReportSchedule{}, id).Error; err != nil {
